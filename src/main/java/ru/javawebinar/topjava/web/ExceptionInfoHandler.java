...
public class ExceptionInfoHandler {
    ...
    public static final String DUPLICATE_EMAIL_ERROR_MESSAGE = "error.user.duplicateEmail";
    public static final String DUPLICATE_MEAL_ERROR_MESSAGE = "error.user.duplicateMeal";
    private static final Map<String, String> CONSTRAINS = Map.of(
            "users_unique_email_idx", DUPLICATE_EMAIL_ERROR_MESSAGE,
            "meals_unique_user_datetime_idx", DUPLICATE_MEAL_ERROR_MESSAGE);
    @Autowired
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        ...
        String[] messages = details.length != 0 ? details : new String[]{rootCause.getMessage()};
        if (logException) {
